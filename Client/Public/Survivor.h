...
namespace Client
{
	...
	********************/
	public:
		...
		float GetCurCoolDownRatio(ESkillType _eSkillType) const;
		...
		float GetAdditionalAttackPower() const { return m_fAdditionalAttackPower; }

		float GetAdditionalDefensePower() const { return m_fAdditionalDefensePower; }
	...
	public:
		void AddAdditionalAttackPower(float _fAdditionalAttackPower) { m_fAdditionalAttackPower += _fAdditionalAttackPower; }

		void AddAdditionalDefensePower(float _fAdditionalDefensePower) { m_fAdditionalDefensePower += _fAdditionalDefensePower; }
	...
	public:
		void PlaySoundEx(const std::string& _strSoundFileName, ESoundType _eSoundType);
	...
	********************/
	protected:
		...
		std::weak_ptr<CEffectComponent> m_wpHitEffectComponent;
	...
	protected:
		...
		// 추가 공격력
		float m_fAdditionalAttackPower = 0.0f;

		// 방어력
		std::array<float, 10> m_arrDefensePower{};

		// 추가 방어력
		float m_fAdditionalDefensePower = 0.0f;
		...
		float m_fSumFootStep = 0.0f;

		float m_fMaxFootStep = 0.45f;
	};
}
