...
std::shared_ptr<CItemBuild> Client::CItemBuild::Create(const shared_ptr<CInventory>& _spInventory)
{
...
HRESULT Client::CItemBuild::Initialize(const shared_ptr<CInventory>& _spInventory)
{
	...
	CreateItemBuildOrder({ EItemType::BATTERY, EItemType::CARBONATED_WATER }, EItemType::ION_BATTERY, EItemCategoryType::MATERIAL, EItemLevel::UNCOMMON);// ÀÌ°Ô µÉ±î?
...
void Client::CItemBuild::Release()
{
...
void Client::CItemBuild::CreateItemBuildOrder
(
...
const std::vector<std::weak_ptr<TItemBuildOrder>>& Client::CItemBuild::CheckItemBuildOrder()
{
...
std::pair<EItemType, EItemType> Client::CItemBuild::FindInputItems(EItemType _eParentItemType)
{
