...
HRESULT Client::CDog::PreInitialize()
{
	{
		m_eWildAnimalType = EWildAnimalType::DOG;
	...
	{
		m_wpHitEffectComponent = CreateActorComponent<CEffectComponent>(L"HitEffectComponent", EComponentType::EFFECT);
...
HRESULT Client::CDog::Initialize()
{
	...
	*/
	...
	{
		m_wpHitEffectComponent.lock()->CreateMeshEffectDataGroup(L"FXHit01");
	}
	return S_OK;
}

HRESULT Client::CDog::PostInitialize()
{
...
int32 Client::CDog::PreTick(float _fDeltaSeconds)
{
...
int32 Client::CDog::Tick(float _fDeltaSeconds)
{
...
int32 Client::CDog::PostTick(float _fDeltaSeconds)
{
...
void Client::CDog::Render()
{
	CWildAnimal::Render();
}

void Client::CDog::Release()
{
	CWildAnimal::Release();
}

void Client::CDog::OnCollisionEnter(std::shared_ptr<CShapeComponent>& _spSrc, std::shared_ptr<CShapeComponent>& _spDst)
{
	CWildAnimal::OnCollisionEnter(_spSrc, _spDst);
}

void Client::CDog::OnCollisionStay(std::shared_ptr<CShapeComponent>& _spSrc, std::shared_ptr<CShapeComponent>& _spDst)
{
	CWildAnimal::OnCollisionStay(_spSrc, _spDst);
}

void Client::CDog::OnCollisionExit(std::shared_ptr<CShapeComponent>& _spSrc, std::shared_ptr<CShapeComponent>& _spDst)
{
	CWildAnimal::OnCollisionExit(_spSrc, _spDst);
}

void Client::CDog::OnAnimEnter(uint32 _iAnimState, uint32 _iAnimIndex, float _fRatio)
{
}

void Client::CDog::OnAnimStay(uint32 _iAnimState, uint32 _iAnimIndex, float _fRatio)
{
}

void Client::CDog::OnAnimExit(uint32 _iAnimState, uint32 _iAnimIndex, float _fRatio)
{
