...
HRESULT Client::CYuki::PreInitialize()
{
...

	{
		...
		m_wpSkeletalMeshComponent.lock()->SetModelDesc(L"Yuki");
...
HRESULT Client::CYuki::Initialize()
{
...
HRESULT Client::CYuki::PostInitialize()
{
...
HRESULT Client::CYuki::BeginPlay()
{
...
int32 Client::CYuki::PreTick(float _fDeltaSeconds)
{
...
int32 Client::CYuki::Tick(float _fDeltaSeconds)
{
...
int32 Client::CYuki::PostTick(float _fDeltaSeconds)
{
...
void Client::CYuki::Render()
{
	CSurvivor::Render();
}

void Client::CYuki::Release()
{
	CSurvivor::Release();
}

void Client::CYuki::OnCollisionEnter(std::shared_ptr<CShapeComponent>& _spSrc, std::shared_ptr<CShapeComponent>& _spDst)
{
	CSurvivor::OnCollisionEnter(_spSrc, _spDst);
}

void Client::CYuki::OnCollisionStay(std::shared_ptr<CShapeComponent>& _spSrc, std::shared_ptr<CShapeComponent>& _spDst)
{
	CSurvivor::OnCollisionStay(_spSrc, _spDst);
}

void Client::CYuki::OnCollisionExit(std::shared_ptr<CShapeComponent>& _spSrc, std::shared_ptr<CShapeComponent>& _spDst)
{
	CSurvivor::OnCollisionExit(_spSrc, _spDst);
}

void Client::CYuki::OnAnimEnter(uint32 _iAnimState, uint32 _iAnimIndex, float _fRatio)
{
}

void Client::CYuki::OnAnimStay(uint32 _iAnimState, uint32 _iAnimIndex, float _fRatio)
{
}

void Client::CYuki::OnAnimExit(uint32 _iAnimState, uint32 _iAnimIndex, float _fRatio)
{
}

void Client::CYuki::MoveForward(int32 _iValue)
{
...
void Client::CYuki::MoveBackward(int32 _iValue)
{
	if (m_wpSurvivorStateComponent.lock()->GetCurAnimState() != (uint32)ESurvivorState::RUN) { return; }
...
void Client::CYuki::MoveRight(int32 _iValue)
{
	if (m_wpSurvivorStateComponent.lock()->GetCurAnimState() != (uint32)ESurvivorState::RUN) { return; }
...
void Client::CYuki::MoveLeft(int32 _iValue)
{
	if (m_wpSurvivorStateComponent.lock()->GetCurAnimState() != (uint32)ESurvivorState::RUN) { return; }
