...
HRESULT Client::CBoarStateComponent::PreInitializeComponent()
{
...
HRESULT Client::CBoarStateComponent::InitializeComponent()
{
...
HRESULT Client::CBoarStateComponent::PostInitializeComponent()
{
...
HRESULT Client::CBoarStateComponent::BeginPlay()
{
...
int32 Client::CBoarStateComponent::PreTickComponent(float _fDeltaSeconds)
{
...
int32 Client::CBoarStateComponent::TickComponent(float _fDeltaSeconds)
{
...
int32 Client::CBoarStateComponent::PostTickComponent(float _fDeltaSeconds)
{
...
HRESULT Client::CBoarStateComponent::EndPlay()
{
...
void Client::CBoarStateComponent::Render()
{
	CWildAnimalStateComponent::Render();
}

void Client::CBoarStateComponent::Release()
{
	CWildAnimalStateComponent::Release();
}

void Client::CBoarStateComponent::UpdateWildAnimalState(float _fDeltaSeconds)
{
	// 낮밤 타입을 업데이트합니다.
...
void Client::CBoarStateComponent::UpdateWildAnimalBehavior(float _fDeltaSeconds)
{
	switch (m_eWildAnimalState)
	{
	case Client::EWildAnimalState::ATTACK_01:
...
void Client::CBoarStateComponent::OnAnimEnter(uint32 _iAnimState, float _fRatio)
{
}

void Client::CBoarStateComponent::OnAnimStay(uint32 _iAnimState, float _fRatio)
{
}

void Client::CBoarStateComponent::OnAnimExit(uint32 _iAnimState, float _fRatio)
{
	...
	case EWildAnimalAnimState::SKILL:			break;// m_eWildAnimalState = EWildAnimalState::CHASE;			break;
