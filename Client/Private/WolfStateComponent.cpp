...
HRESULT Client::CWolfStateComponent::PreInitializeComponent()
{
...
HRESULT Client::CWolfStateComponent::InitializeComponent()
{
...
HRESULT Client::CWolfStateComponent::PostInitializeComponent()
{
...
HRESULT Client::CWolfStateComponent::BeginPlay()
{
...
int32 Client::CWolfStateComponent::PreTickComponent(float _fDeltaSeconds)
{
...
int32 Client::CWolfStateComponent::TickComponent(float _fDeltaSeconds)
{
...
int32 Client::CWolfStateComponent::PostTickComponent(float _fDeltaSeconds)
{
...
HRESULT Client::CWolfStateComponent::EndPlay()
{
...
void Client::CWolfStateComponent::Render()
{
	CWildAnimalStateComponent::Render();
}

void Client::CWolfStateComponent::Release()
{
	CWildAnimalStateComponent::Release();
}

void Client::CWolfStateComponent::UpdateWildAnimalState(float _fDeltaSeconds)
{
	// 낮밤 타입을 업데이트합니다.
	...
	case Client::EWildAnimalState::RETREAT:
	{
		...
		float fDistance = Vector3::Distance(m_wpWildAnimal.lock()->GetSpawnPosition(), m_wpWildAnimal.lock()->GetActorWorldPosition().value());
		if (fDistance <= 1.5f)
		{
			switch (m_eWildAnimalHabitType)
			{
...
void Client::CWolfStateComponent::UpdateWildAnimalBehavior(float _fDeltaSeconds)
{
	switch (m_eWildAnimalState)
	{
	case Client::EWildAnimalState::ATTACK_01:
...
void Client::CWolfStateComponent::OnAnimEnter(uint32 _iAnimState, float _fRatio)
{
}

void Client::CWolfStateComponent::OnAnimStay(uint32 _iAnimState, float _fRatio)
{
}

void Client::CWolfStateComponent::OnAnimExit(uint32 _iAnimState, float _fRatio)
{
