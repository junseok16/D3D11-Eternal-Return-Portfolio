...
HRESULT Client::CItemBoxPanel::PreInitialize()
{
...
HRESULT Client::CItemBoxPanel::Initialize()
{
...
HRESULT Client::CItemBoxPanel::PostInitialize()
{
	...
	// 상자 텍스트
	shared_ptr<CItemBoxText> spItemBoxText = spLevel->CreateUI<CItemBoxText>(L"ItemBoxText");
	spItemBoxText->SetFontName(L"KBIZM");
	spItemBoxText->SetPriority(5);
	AddUI(L"ItemBoxText", spItemBoxText);
...
HRESULT Client::CItemBoxPanel::BeginPlay()
{
...
int32 Client::CItemBoxPanel::PreTick(float _fDeltaSeconds)
{
...
int32 Client::CItemBoxPanel::Tick(float _fDeltaSeconds)
{
...
int32 Client::CItemBoxPanel::PostTick(float _fDeltaSeconds)
{
...
HRESULT Client::CItemBoxPanel::EndPlay()
{
...
void Client::CItemBoxPanel::Render()
{
	CPanel::Render();
}

void Client::CItemBoxPanel::Release()
{
	CPanel::Release();
}

void Client::CItemBoxPanel::SetItem(const std::shared_ptr<CItem>& _spItem, int32 _iSlot)
{
