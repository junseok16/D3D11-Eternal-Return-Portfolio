...
HRESULT Client::CSkillPanel::PreInitialize()
{
...
HRESULT Client::CSkillPanel::Initialize()
{
...
HRESULT Client::CSkillPanel::PostInitialize()
{
...
HRESULT Client::CSkillPanel::BeginPlay()
{
...
int32 Client::CSkillPanel::PreTick(float _fDeltaSeconds)
{
...
int32 Client::CSkillPanel::Tick(float _fDeltaSeconds)
{
...
int32 Client::CSkillPanel::PostTick(float _fDeltaSeconds)
{
...
HRESULT Client::CSkillPanel::EndPlay()
{
...
void Client::CSkillPanel::Render()
{
	CPanel::Render();
}

void Client::CSkillPanel::Release()
{
	CPanel::Release();
}
