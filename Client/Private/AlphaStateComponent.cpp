...
HRESULT Client::CAlphaStateComponent::PreInitializeComponent()
{
...
HRESULT Client::CAlphaStateComponent::InitializeComponent()
{
...
HRESULT Client::CAlphaStateComponent::PostInitializeComponent()
{
...
HRESULT Client::CAlphaStateComponent::BeginPlay()
{
...
int32 Client::CAlphaStateComponent::PreTickComponent(float _fDeltaSeconds)
{
...
int32 Client::CAlphaStateComponent::TickComponent(float _fDeltaSeconds)
{
...
int32 Client::CAlphaStateComponent::PostTickComponent(float _fDeltaSeconds)
{
...
HRESULT Client::CAlphaStateComponent::EndPlay()
{
...
void Client::CAlphaStateComponent::Render()
{
	CBossStateComponent::Render();
}

void Client::CAlphaStateComponent::Release()
{
	CBossStateComponent::Release();
}

void Client::CAlphaStateComponent::UpdateBossState(float _fDeltaSeconds)
{
...
void Client::CAlphaStateComponent::UpdateBossBehavior(float _fDeltaSeconds)
{
	switch (m_eBossState)
	{
	case Client::EBossState::WANDER:
...
void Client::CAlphaStateComponent::OnAnimEnter(uint32 _iAnimState, float _fRatio)
{
}

void Client::CAlphaStateComponent::OnAnimStay(uint32 _iAnimState, float _fRatio)
{
}

void Client::CAlphaStateComponent::OnAnimExit(uint32 _iAnimState, float _fRatio)
{
