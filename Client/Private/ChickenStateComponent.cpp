...
HRESULT Client::CChickenStateComponent::PreInitializeComponent()
{
...
HRESULT Client::CChickenStateComponent::InitializeComponent()
{
...
HRESULT Client::CChickenStateComponent::PostInitializeComponent()
{
...
HRESULT Client::CChickenStateComponent::BeginPlay()
{
...
int32 Client::CChickenStateComponent::PreTickComponent(float _fDeltaSeconds)
{
...
int32 Client::CChickenStateComponent::TickComponent(float _fDeltaSeconds)
{
...
int32 Client::CChickenStateComponent::PostTickComponent(float _fDeltaSeconds)
{
...
HRESULT Client::CChickenStateComponent::EndPlay()
{
...
void Client::CChickenStateComponent::Render()
{
	CWildAnimalStateComponent::Render();
}

void Client::CChickenStateComponent::Release()
{
	CWildAnimalStateComponent::Release();
}

void Client::CChickenStateComponent::UpdateWildAnimalState(float _fDeltaSeconds)
{
	// 낮밤 타입을 업데이트합니다.
...
void Client::CChickenStateComponent::UpdateWildAnimalBehavior(float _fDeltaSeconds)
{
	switch (m_eWildAnimalState)
	{
	case Client::EWildAnimalState::ATTACK_01:
...
void Client::CChickenStateComponent::OnAnimEnter(uint32 _iAnimState, float _fRatio)
{
}

void Client::CChickenStateComponent::OnAnimStay(uint32 _iAnimState, float _fRatio)
{
}

void Client::CChickenStateComponent::OnAnimExit(uint32 _iAnimState, float _fRatio)
{
