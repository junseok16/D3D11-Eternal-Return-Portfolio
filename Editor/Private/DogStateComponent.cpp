...
HRESULT Editor::CDogStateComponent::PreInitializeComponent()
{
...
HRESULT Editor::CDogStateComponent::InitializeComponent()
{
...
HRESULT Editor::CDogStateComponent::PostInitializeComponent()
{
...
HRESULT Editor::CDogStateComponent::BeginPlay()
{
...
int32 Editor::CDogStateComponent::PreTickComponent(float _fDeltaSeconds)
{
...
int32 Editor::CDogStateComponent::TickComponent(float _fDeltaSeconds)
{
...
int32 Editor::CDogStateComponent::PostTickComponent(float _fDeltaSeconds)
{
...
HRESULT Editor::CDogStateComponent::EndPlay()
{
...
void Editor::CDogStateComponent::Render()
{
	CWildAnimalStateComponent::Render();
}

void Editor::CDogStateComponent::Release()
{
	CWildAnimalStateComponent::Release();
}

void Editor::CDogStateComponent::UpdateWildAnimalState(float _fDeltaSeconds)
{
	// 낮밤 타입을 업데이트합니다.
...
void Editor::CDogStateComponent::UpdateWildAnimalBehavior(float _fDeltaSeconds)
{
	switch (m_eWildAnimalState)
	{
	case Editor::EWildAnimalState::ATTACK_01:
...
void Editor::CDogStateComponent::OnAnimEnter(uint32 _iAnimState, float _fRatio)
{
}

void Editor::CDogStateComponent::OnAnimStay(uint32 _iAnimState, float _fRatio)
{
}

void Editor::CDogStateComponent::OnAnimExit(uint32 _iAnimState, float _fRatio)
{
