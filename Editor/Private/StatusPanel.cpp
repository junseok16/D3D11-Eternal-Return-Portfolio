...
HRESULT Editor::CStatusPanel::PreInitialize()
{
...
HRESULT Editor::CStatusPanel::Initialize()
{
...
HRESULT Editor::CStatusPanel::PostInitialize()
{
	...
	spStatusCharLevelText->SetPriority(5);
...
HRESULT Editor::CStatusPanel::BeginPlay()
{
...
int32 Editor::CStatusPanel::PreTick(float _fDeltaSeconds)
{
...
int32 Editor::CStatusPanel::Tick(float _fDeltaSeconds)
{
...
int32 Editor::CStatusPanel::PostTick(float _fDeltaSeconds)
{
...
HRESULT Editor::CStatusPanel::EndPlay()
{
...
void Editor::CStatusPanel::Render()
{
	CPanel::Render();
}

void Editor::CStatusPanel::Release()
{
	CPanel::Release();
}

void Editor::CStatusPanel::SetEquipment(const std::shared_ptr<CItem>& _spItem, int32 _iSlot)
{
