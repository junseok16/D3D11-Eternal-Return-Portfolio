...
HRESULT Editor::CChickenStateComponent::PreInitializeComponent()
{
...
HRESULT Editor::CChickenStateComponent::InitializeComponent()
{
...
HRESULT Editor::CChickenStateComponent::PostInitializeComponent()
{
...
HRESULT Editor::CChickenStateComponent::BeginPlay()
{
...
int32 Editor::CChickenStateComponent::PreTickComponent(float _fDeltaSeconds)
{
...
int32 Editor::CChickenStateComponent::TickComponent(float _fDeltaSeconds)
{
...
int32 Editor::CChickenStateComponent::PostTickComponent(float _fDeltaSeconds)
{
...
HRESULT Editor::CChickenStateComponent::EndPlay()
{
...
void Editor::CChickenStateComponent::Render()
{
	CWildAnimalStateComponent::Render();
}

void Editor::CChickenStateComponent::Release()
{
	CWildAnimalStateComponent::Release();
}

void Editor::CChickenStateComponent::UpdateWildAnimalState(float _fDeltaSeconds)
{
	// 낮밤 타입을 업데이트합니다.
...
void Editor::CChickenStateComponent::UpdateWildAnimalBehavior(float _fDeltaSeconds)
{
	switch (m_eWildAnimalState)
	{
	case Editor::EWildAnimalState::ATTACK_01:
...
void Editor::CChickenStateComponent::OnAnimEnter(uint32 _iAnimState, float _fRatio)
{
}

void Editor::CChickenStateComponent::OnAnimStay(uint32 _iAnimState, float _fRatio)
{
}

void Editor::CChickenStateComponent::OnAnimExit(uint32 _iAnimState, float _fRatio)
{
