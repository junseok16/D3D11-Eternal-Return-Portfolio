...
HRESULT Editor::CBearStateComponent::PreInitializeComponent()
{
...
HRESULT Editor::CBearStateComponent::InitializeComponent()
{
...
HRESULT Editor::CBearStateComponent::PostInitializeComponent()
{
...
HRESULT Editor::CBearStateComponent::BeginPlay()
{
...
int32 Editor::CBearStateComponent::PreTickComponent(float _fDeltaSeconds)
{
...
int32 Editor::CBearStateComponent::TickComponent(float _fDeltaSeconds)
{
...
int32 Editor::CBearStateComponent::PostTickComponent(float _fDeltaSeconds)
{
...
HRESULT Editor::CBearStateComponent::EndPlay()
{
...
void Editor::CBearStateComponent::Render()
{
	CWildAnimalStateComponent::Render();
}

void Editor::CBearStateComponent::Release()
{
	CWildAnimalStateComponent::Release();
}

void Editor::CBearStateComponent::UpdateWildAnimalState(float _fDeltaSeconds)
{
	// 낮밤 타입을 업데이트합니다.
...
void Editor::CBearStateComponent::UpdateWildAnimalBehavior(float _fDeltaSeconds)
{
	switch (m_eWildAnimalState)
	{
	case Editor::EWildAnimalState::ATTACK_01:
...
void Editor::CBearStateComponent::OnAnimEnter(uint32 _iAnimState, float _fRatio)
{
}

void Editor::CBearStateComponent::OnAnimStay(uint32 _iAnimState, float _fRatio)
{
}

void Editor::CBearStateComponent::OnAnimExit(uint32 _iAnimState, float _fRatio)
{
