...
HRESULT Editor::CAlphaStateComponent::PreInitializeComponent()
{
...
HRESULT Editor::CAlphaStateComponent::InitializeComponent()
{
...
HRESULT Editor::CAlphaStateComponent::PostInitializeComponent()
{
...
HRESULT Editor::CAlphaStateComponent::BeginPlay()
{
...
int32 Editor::CAlphaStateComponent::PreTickComponent(float _fDeltaSeconds)
{
...
int32 Editor::CAlphaStateComponent::TickComponent(float _fDeltaSeconds)
{
...
int32 Editor::CAlphaStateComponent::PostTickComponent(float _fDeltaSeconds)
{
...
HRESULT Editor::CAlphaStateComponent::EndPlay()
{
...
void Editor::CAlphaStateComponent::Render()
{
	CBossStateComponent::Render();
}

void Editor::CAlphaStateComponent::Release()
{
	CBossStateComponent::Release();
}

void Editor::CAlphaStateComponent::UpdateBossState(float _fDeltaSeconds)
{
...
void Editor::CAlphaStateComponent::UpdateBossBehavior(float _fDeltaSeconds)
{
	switch (m_eBossState)
	{
	case Editor::EBossState::WANDER:
...
void Editor::CAlphaStateComponent::OnAnimEnter(uint32 _iAnimState, float _fRatio)
{
}

void Editor::CAlphaStateComponent::OnAnimStay(uint32 _iAnimState, float _fRatio)
{
}

void Editor::CAlphaStateComponent::OnAnimExit(uint32 _iAnimState, float _fRatio)
{
