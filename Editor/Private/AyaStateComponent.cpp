...
HRESULT Editor::CAyaStateComponent::PreInitializeComponent()
{
...
HRESULT Editor::CAyaStateComponent::InitializeComponent()
{
...
HRESULT Editor::CAyaStateComponent::PostInitializeComponent()
{
...
HRESULT Editor::CAyaStateComponent::BeginPlay()
{
...
int32 Editor::CAyaStateComponent::PreTickComponent(float _fDeltaSeconds)
{
...
int32 Editor::CAyaStateComponent::TickComponent(float _fDeltaSeconds)
{
...
int32 Editor::CAyaStateComponent::PostTickComponent(float _fDeltaSeconds)
{
...
HRESULT Editor::CAyaStateComponent::EndPlay()
{
...
void Editor::CAyaStateComponent::Render()
{
	CStateComponent::Render();
}

void Editor::CAyaStateComponent::Release()
{
	CStateComponent::Release();
}

void Editor::CAyaStateComponent::UpdateSurvivorState(float _fDeltaSeconds)
{
...
void Editor::CAyaStateComponent::OnAnimEnter(uint32 _iAnimState, float _fRatio)
{

}

void Editor::CAyaStateComponent::OnAnimStay(uint32 _iAnimState, float _fRatio)
{

}

void Editor::CAyaStateComponent::OnAnimExit(uint32 _iAnimState, float _fRatio)
{
...
void Editor::CAyaStateComponent::EatItem()
{
