...
HRESULT Editor::CWolfStateComponent::PreInitializeComponent()
{
...
HRESULT Editor::CWolfStateComponent::InitializeComponent()
{
...
HRESULT Editor::CWolfStateComponent::PostInitializeComponent()
{
...
HRESULT Editor::CWolfStateComponent::BeginPlay()
{
...
int32 Editor::CWolfStateComponent::PreTickComponent(float _fDeltaSeconds)
{
...
int32 Editor::CWolfStateComponent::TickComponent(float _fDeltaSeconds)
{
...
int32 Editor::CWolfStateComponent::PostTickComponent(float _fDeltaSeconds)
{
...
HRESULT Editor::CWolfStateComponent::EndPlay()
{
...
void Editor::CWolfStateComponent::Render()
{
	CWildAnimalStateComponent::Render();
}

void Editor::CWolfStateComponent::Release()
{
	CWildAnimalStateComponent::Release();
}

void Editor::CWolfStateComponent::UpdateWildAnimalState(float _fDeltaSeconds)
{
	// 낮밤 타입을 업데이트합니다.
...
void Editor::CWolfStateComponent::UpdateWildAnimalBehavior(float _fDeltaSeconds)
{
	switch (m_eWildAnimalState)
	{
	case Editor::EWildAnimalState::ATTACK_01:
...
void Editor::CWolfStateComponent::OnAnimEnter(uint32 _iAnimState, float _fRatio)
{
}

void Editor::CWolfStateComponent::OnAnimStay(uint32 _iAnimState, float _fRatio)
{
}

void Editor::CWolfStateComponent::OnAnimExit(uint32 _iAnimState, float _fRatio)
{
