...
HRESULT Editor::CItemPanel::PreInitialize()
{
...
HRESULT Editor::CItemPanel::Initialize()
{
...
HRESULT Editor::CItemPanel::PostInitialize()
{
...
HRESULT Editor::CItemPanel::BeginPlay()
{
...
int32 Editor::CItemPanel::PreTick(float _fDeltaSeconds)
{
...
int32 Editor::CItemPanel::Tick(float _fDeltaSeconds)
{
...
int32 Editor::CItemPanel::PostTick(float _fDeltaSeconds)
{
...
HRESULT Editor::CItemPanel::EndPlay()
{
...
void Editor::CItemPanel::Render()
{
	CPanel::Render();
}

void Editor::CItemPanel::Release()
{
	CPanel::Release();
}

void Editor::CItemPanel::SetItem(const std::shared_ptr<CItem>& _spItem, int32 _iSlot)
{
...
void Editor::CItemPanel::SetCraft(const std::shared_ptr<CItem>& _spItem, int32 _iSlot)
{
