...
HRESULT Editor::CRozzi::PreInitialize()
{
...
HRESULT Editor::CRozzi::Initialize()
{
...
HRESULT Editor::CRozzi::PostInitialize()
{
...
HRESULT Editor::CRozzi::BeginPlay()
{
...
int32 Editor::CRozzi::PreTick(float _fDeltaSeconds)
{
...
int32 Editor::CRozzi::Tick(float _fDeltaSeconds)
{
...
int32 Editor::CRozzi::PostTick(float _fDeltaSeconds)
{
...
void Editor::CRozzi::Render()
{
	CSurvivor::Render();
}

void Editor::CRozzi::Release()
{
	CSurvivor::Release();
}

void Editor::CRozzi::OnCollisionEnter(std::shared_ptr<CShapeComponent>& _spSrc, std::shared_ptr<CShapeComponent>& _spDst)
{
	CSurvivor::OnCollisionEnter(_spSrc, _spDst);
}

void Editor::CRozzi::OnCollisionStay(std::shared_ptr<CShapeComponent>& _spSrc, std::shared_ptr<CShapeComponent>& _spDst)
{
	CSurvivor::OnCollisionStay(_spSrc, _spDst);
}

void Editor::CRozzi::OnCollisionExit(std::shared_ptr<CShapeComponent>& _spSrc, std::shared_ptr<CShapeComponent>& _spDst)
{
	CSurvivor::OnCollisionExit(_spSrc, _spDst);
}

void Editor::CRozzi::OnAnimEnter(uint32 _iAnimState, uint32 _iAnimIndex, float _fRatio)
{
...
void Editor::CRozzi::OnAnimStay(uint32 _iAnimState, uint32 _iAnimIndex, float _fRatio)
{
	switch (static_cast<ESurvivorState>(_iAnimState))
	{
...
void Editor::CRozzi::OnAnimExit(uint32 _iAnimState, uint32 _iAnimIndex, float _fRatio)
{
	switch (static_cast<ESurvivorState>(_iAnimState))
	{
...
void Editor::CRozzi::MoveForward(int32 _iValue)
{
...
void Editor::CRozzi::MoveBackward(int32 _iValue)
{
	if (m_wpSurvivorStateComponent.lock()->GetCurAnimState() != (uint32)ESurvivorState::RUN) { return; }
...
void Editor::CRozzi::MoveRight(int32 _iValue)
{
	if (m_wpSurvivorStateComponent.lock()->GetCurAnimState() != (uint32)ESurvivorState::RUN) { return; }
...
void Editor::CRozzi::MoveLeft(int32 _iValue)
{
	if (m_wpSurvivorStateComponent.lock()->GetCurAnimState() != (uint32)ESurvivorState::RUN) { return; }
