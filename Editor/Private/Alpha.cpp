...
HRESULT Editor::CAlpha::PreInitialize()
{
	{
		m_fAttackRange = 2.0f;
...
HRESULT Editor::CAlpha::Initialize()
{
...
HRESULT Editor::CAlpha::PostInitialize()
{
...
HRESULT Editor::CAlpha::BeginPlay()
{
...
int32 Editor::CAlpha::PreTick(float _fDeltaSeconds)
{
...
int32 Editor::CAlpha::Tick(float _fDeltaSeconds)
{
...
int32 Editor::CAlpha::PostTick(float _fDeltaSeconds)
{
...
void Editor::CAlpha::OnCollisionEnter(std::shared_ptr<CShapeComponent>& _spSrc, std::shared_ptr<CShapeComponent>& _spDst)
{
	CBoss::OnCollisionEnter(_spSrc, _spDst);
}

void Editor::CAlpha::OnCollisionStay(std::shared_ptr<CShapeComponent>& _spSrc, std::shared_ptr<CShapeComponent>& _spDst)
{
	CBoss::OnCollisionStay(_spSrc, _spDst);
}

void Editor::CAlpha::OnCollisionExit(std::shared_ptr<CShapeComponent>& _spSrc, std::shared_ptr<CShapeComponent>& _spDst)
{
	CBoss::OnCollisionExit(_spSrc, _spDst);
}

void Editor::CAlpha::OnAnimEnter(uint32 _iAnimState, uint32 _iAnimIndex, float _fRatio)
{
...
void Editor::CAlpha::OnAnimStay(uint32 _iAnimState, uint32 _iAnimIndex, float _fRatio)
{
}

void Editor::CAlpha::OnAnimExit(uint32 _iAnimState, uint32 _iAnimIndex, float _fRatio)
{
	switch (static_cast<EBossAnimState>(_iAnimState))
	{
	case EBossAnimState::ATTACK_01:
